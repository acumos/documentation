...
.. note::
    The Splitter and Collator require that specific "Data Transformation & Toolkit" models be onboarded in order for the functionality to be enabled. If you do not see a Collator and a Splitter in the **Data Transform Tools** palette, your Acumos instance does not support Splitter and Collator functionality. Contact your Acumos Admin for details.
