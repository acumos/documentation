...
* Jupyter Notebooks integration allows the creation and training of AI/ML models in Acumos
* Onboarding of ONNX, PFA and Dockerized models
* Enhanced user experience in portal with the introduction of Catalogs.
