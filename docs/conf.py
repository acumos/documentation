...
# -*- coding: utf-8 -*-
#
# Acumos documentation build configuration file, created by
...
project = u'Acumos'
copyright = u'2019, The Acumos Project. Licensed under CC BY 4.0.'
...
html_logo = '_static/images/logo_acumos.png'
...
man_pages = [
    (master_doc, 'acumos', u'Acumos Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Acumos', u'Acumos Documentation',
     author, 'Acumos', 'One line description of project.',
     'Miscellaneous'),
]
